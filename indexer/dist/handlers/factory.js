...
exports.handleFactoryMarketCreated = handleFactoryMarketCreated;
const db_1 = require("../db");
const helpers_1 = require("./helpers");
/**
 * Factory fallback: if EventEmitter misses MarketCreated, create Market here.
 */
async function handleFactoryMarketCreated(log, blockNumber, timestamp, txHash, logIndex) {
    ...
    const tokenTotalSupply = (0, helpers_1.toDecimal)((BigInt(1_000_000_000) * BigInt(10 ** 18)).toString(), decimals);
    await db.query(`INSERT INTO token (id, address, name, symbol, decimals, total_supply, holder_count, transfer_count, created_at)
     VALUES ($1,$2,$3,$4,$5,$6,0,0,$7) ON CONFLICT (id) DO NOTHING`, [tokenAddr, tokenAddr, tokenName, tokenSymbol, decimals, tokenTotalSupply, timestamp]);
    const reserveUSID = (0, helpers_1.toDecimal)(reserveUSIDRaw, 18);
    const reserveToken = (0, helpers_1.toDecimal)(reserveTokenRaw, decimals);
